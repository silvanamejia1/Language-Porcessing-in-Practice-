...
class RAGAgent:
    ...
    def ask(self, question: str) -> dict:
        ...
        task = Task(description = question,
                    agent = agent,
                    expected_output = "A detailed travel recommendation based on the databse articles. Divide destinations in similar categories (ex: by activities, by countries), build iteneraries if requested")
